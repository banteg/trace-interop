...
```json
{
  "error": {
    "code": -32602,
    "message": "invalid argument 1: json: cannot unmarshal string into Go value of type []string"
  },
  "id": 1,
  "jsonrpc": "2.0"
}
...
```json
{
  "error": {
    "code": -32602,
    "data": "invalid type: string \"trace\", expected a sequence at line 1 column 8",
    "message": "Invalid params"
  },
  "id": 1,
  "jsonrpc": "2.0"
