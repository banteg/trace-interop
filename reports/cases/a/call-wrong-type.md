...
```json
{
  "error": {
    "code": -32602,
    "message": "invalid argument 0: json: cannot unmarshal non-string into Go struct field TransactionArgs.gas of type hexutil.Uint64"
  },
  "id": 1,
  "jsonrpc": "2.0"
}
...
```json
{
  "error": {
    "code": -32602,
    "message": "invalid argument 0: json: cannot unmarshal non-string into Go value of type hexutil.Uint64"
  },
  "id": 1,
  "jsonrpc": "2.0"
}
...
```json
{
  "error": {
    "code": -32602,
    "message": "invalid argument 0: json: cannot unmarshal non-string into Go struct field TraceCallParam.gas of type hexutil.Uint64"
  },
  "id": 1,
  "jsonrpc": "2.0"
}
...
```json
{
  "error": {
    "code": -32602,
    "data": "invalid type: map, expected a 8 byte hex string at line 1 column 116",
    "message": "Invalid params"
  },
  "id": 1,
  "jsonrpc": "2.0"
