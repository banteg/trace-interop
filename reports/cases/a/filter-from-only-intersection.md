...
- [H14](../../decisions/H14.md): Assess the declared property. A one-sided intersection filter is valid input; H03 checks its result. Invalid-input codes do not apply.
