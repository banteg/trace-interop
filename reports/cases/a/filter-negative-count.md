...
```json
{
  "error": {
    "code": -32602,
    "message": "invalid argument 0: json: cannot unmarshal number -1 into Go struct field plain.count of type uint64"
  },
  "id": 1,
  "jsonrpc": "2.0"
}
...
```json
{
  "error": {
    "code": -32602,
    "message": "invalid argument 0: json: cannot unmarshal number -1 into Go struct field TraceFilterRequest.count of type uint64"
  },
  "id": 1,
  "jsonrpc": "2.0"
}
...
```json
{
  "error": {
    "code": -32602,
    "data": "invalid value: integer `-1`, expected u64 at line 1 column 50",
