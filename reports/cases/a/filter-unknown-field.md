...
```json
{
  "error": {
    "code": -32602,
    "message": "invalid argument 0: json: unknown field \"unknownDiagnosticFlag\""
  },
  "id": 1,
  "jsonrpc": "2.0"
}
...
```json
{
  "error": {
    "code": -32602,
    "data": "unknown field `unknownDiagnosticFlag`, expected one of `fromBlock`, `toBlock`, `fromAddress`, `toAddress`, `mode`, `after`, `count` at line 1 column 62",
