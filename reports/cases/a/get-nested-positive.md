...
- H02: **matches** — Return the transaction-tree record at [6, 0], or null if absent.
...
- H02: **change_needed** — Return the transaction-tree record at [6, 0], or null if absent.
