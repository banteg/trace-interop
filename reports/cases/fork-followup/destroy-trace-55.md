# fork-followup/destroy-trace-55
...
- H26: **matches** — Delete code/nonce before Cancun; preserve an existing account after EIP-6780.
      ...
      "0x7435ed30a8b4aeb0877cef0c6e8cffe834eb865f": {
        "balance": {
          "*": {
            ...
            "to": "0xc097ce7bc90715b34796f5186d5d58"
          }
        },
        "code": "=",
        "nonce": {
...
- H08: **matches** — Output remains a byte string under every trace selection.
- H21: **matches** — Stack words use minimal hex quantities at every depth.
- H26: **change_needed** — Delete code/nonce before Cancun; preserve an existing account after EIP-6780.

Draft result schema: **invalid**.
- `stateDiff`: {'0x0000000000000000000000000000000000000000': {'balance': {'*': {'from': '0xc4f200cb8a8742bfd', 'to': '0xc4f206a5aa5411442'}}, 'code': '=', 'nonce': '=', 'storage': {}}, '0x0000000000000000000000000000000000001007': {'balance': {'*': {'from': '0x64', 'to': None}}, 'code': {'*': {'from': '0x611008ff
