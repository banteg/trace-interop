# fork-followup/system-beacon-55-8751
...
- H28: **change_needed** — Historical beacon-root storage excludes the following block system update.
...
```json
{
  "id": 1,
  "jsonrpc": "2.0",
  "result": "0x83472eda6eb475906aeeb7f09e757ba9f6663b9f6a5bf8611d6306f677f67ebd"
}
```
