# initial/raw-valid-default-block
...
Capture: **rpc_error**; scenario eligible: **True**. [Full evidence](../../../evidence/2026-09-21/geth-final-initial/observations.json).
...
```json
{
  "error": {
    "code": -32000,
    "message": "nonce too low: address 0x7435ed30A8b4AEb0877CEf0c6E8cFFe834eb865f, tx: 0 state: 133"
  },
  "id": 1,
  "jsonrpc": "2.0"
}
...
```json
{
  "error": {
    "code": -32000,
    "message": "nonce too low: next nonce 133, tx nonce 0"
  },
  "id": 1,
  "jsonrpc": "2.0"
}
