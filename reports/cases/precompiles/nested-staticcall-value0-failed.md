# precompiles/nested-staticcall-value0-failed
...
```json
{
  ...
  "result": {
    ...
    "trace": [
      {
        "action": {
          ...
          "from": "0x7435ed30a8b4aeb0877cef0c6e8cffe834eb865f",
          "gas": "0xf2f92",
          "init": "0x602a60005260406000608060006006620186a0fa5060006000f3",
          "value": "0x0"
        },
        "result": {
    ...
    "vmTrace": {
      "code": "0x602a60005260406000608060006006620186a0fa5060006000f3",
      "ops": [
        {
          "cost": 3,
          "ex": {
...
- `trace/0`: {'action': {'from': '0x7435ed30a8b4aeb0877cef0c6e8cffe834eb865f', 'gas': '0xf2f92', 'init': '0x602a60005260406000608060006006620186a0fa5060006000f3', 'value': '0x0'}, 'error': 'Precompile error', 'subtraces': 0, 'traceAddress': [], 'type': 'create'} is not valid under any of the given schemas
...
Draft result schema: **invalid**.
- `vmTrace`: {'code': '0x602a60005260406000608060006006620186a0fa5060006000f3', 'ops': [{'cost': 3, 'ex': {'mem': None, 'push': ['0x2a'], 'store': None, 'used': 995215}, 'pc': 0, 'sub': None}, {'cost': 3, 'ex': {'mem': None, 'push': ['0x00'], 'store': None, 'used': 995212}, 'pc': 2, 'sub': None}, {'cost': 6, 'ex
