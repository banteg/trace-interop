...
```json
{
  "id": 1,
  "jsonrpc": "2.0",
  "result": "besu/v26.8.1/linux-x86_64/openjdk-java-25"
}
```
...
```json
{
  "id": 1,
  "jsonrpc": "2.0",
  "result": "erigon/3.8.0/linux-amd64/go1.27.1"
}
```
...
```json
{
  "id": 1,
  "jsonrpc": "2.0",
  "result": "erigon/3.6.1/linux-amd64/go1.26.8"
}
```
...
```json
{
  "id": 1,
  "jsonrpc": "2.0",
  "result": "Nethermind/v2.1.0-unstable+a404c4f0-f/linux-x64/dotnet10.0.12"
}
```
...
```json
{
  "id": 1,
  "jsonrpc": "2.0",
  "result": "Nethermind/v1.39.3+28cbe2a0/linux-x64/dotnet10.0.10"
}
```
