...
| [H03 — Filter composition and mode](../decisions/H03.md) | 2 change needed, 7 matches | Address matching is OR within each list, AND across lists, with action-specific endpoints. |
| [H04 — Empty address lists](../decisions/H04.md) | 1 change needed, 3 matches | The draft rejects null filters; accepts null, so stricter validation is a compatibility change. |
...
| [H09 — Failed frame results and error labels](../decisions/H09.md) | 21 change needed | Retain revert bytes and gas where available; use null for inapplicable result. |
| [H10 — Creation result field names](../decisions/H10.md) | 2 change needed, 7 matches | Use address, code and gasUsed consistently for successful creation frames. |
...
| [H21 — vmTrace numeric and optional metadata encoding](../decisions/H21.md) | 55 matches | No change identified by these checks. |
...
| [H26 — Account deletion across Cancun](../decisions/H26.md) | 2 matches | No change identified by these checks. |
...
| [H28 — Historical state at system-operation boundaries](../decisions/H28.md) | 6 matches | No change identified by these checks. |
...
<details><summary>H21: 55 assertion checks</summary>
...
<details><summary>H26: 2 assertion checks</summary>
...
<details><summary>H28: 6 assertion checks</summary>
