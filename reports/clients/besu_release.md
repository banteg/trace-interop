...
- **matches** · `precompiles-final` / `nested-call-value0-success`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^nested-call-value0-success$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-call-value0-failed`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^nested-call-value0-failed$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-call-value1-success`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^nested-call-value1-success$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-call-value1-failed`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^nested-call-value1-failed$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-staticcall-value0-success`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^nested-staticcall-value0-success$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-staticcall-value0-failed`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^nested-staticcall-value0-failed$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-delegatecall-value0-success`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^nested-delegatecall-value0-success$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-delegatecall-value0-failed`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^nested-delegatecall-value0-failed$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-delegatecall-value1-success`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^nested-delegatecall-value1-success$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-delegatecall-value1-failed`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^nested-delegatecall-value1-failed$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-callcode-value0-success`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^nested-callcode-value0-success$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-callcode-value0-failed`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^nested-callcode-value0-failed$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-callcode-value1-success`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^nested-callcode-value1-success$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-callcode-value1-failed`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^nested-callcode-value1-failed$" --output runs/reproduce`
- **matches** · `precompiles-final` / `root-success`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^root-success$" --output runs/reproduce`
- **matches** · `precompiles-final` / `root-failed`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^root-failed$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-return42`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/call-return42.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-return42$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-siblings-ok-revert`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/call-siblings-ok-revert.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-siblings-ok-revert$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-siblings-revert-ok`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/call-siblings-revert-ok.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-siblings-revert-ok$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-mixed-create`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/call-mixed-create.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-mixed-create$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-gas7400`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/call-gas7400.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-gas7400$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-mcopy`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/call-mcopy.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-mcopy$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-destroy`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/call-destroy.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-destroy$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `state-only-nonempty-output`: Unrequested trace is an empty array.
  [Compare responses](../cases/a/state-only-nonempty-output.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^state-only-nonempty-output$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `state-only-nonempty-output`: Unrequested vmTrace is null.
  [Compare responses](../cases/a/state-only-nonempty-output.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^state-only-nonempty-output$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `state-only-nonempty-output`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/state-only-nonempty-output.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^state-only-nonempty-output$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `state-only-nonempty-output`: The return42 contract still returns word 42.
  [Compare responses](../cases/a/state-only-nonempty-output.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^state-only-nonempty-output$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `vm-only-nonempty-output`: Unrequested trace is an empty array.
  [Compare responses](../cases/a/vm-only-nonempty-output.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^vm-only-nonempty-output$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `vm-only-nonempty-output`: Unrequested stateDiff is null.
  [Compare responses](../cases/a/vm-only-nonempty-output.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^vm-only-nonempty-output$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `vm-only-nonempty-output`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/vm-only-nonempty-output.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^vm-only-nonempty-output$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `vm-only-nonempty-output`: The return42 contract still returns word 42.
  [Compare responses](../cases/a/vm-only-nonempty-output.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^vm-only-nonempty-output$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `prefunded-empty`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/prefunded-empty.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^prefunded-empty$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `empty-types`: Unrequested trace is an empty array.
  [Compare responses](../cases/a/empty-types.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^empty-types$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `empty-types`: Unrequested vmTrace is null.
  [Compare responses](../cases/a/empty-types.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^empty-types$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `empty-types`: Unrequested stateDiff is null.
  [Compare responses](../cases/a/empty-types.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^empty-types$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `empty-types`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/empty-types.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^empty-types$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `control-storage-after-many`: Unrequested vmTrace is null.
  [Compare responses](../cases/a/control-storage-after-many.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^control-storage-after-many$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `control-storage-after-many`: Unrequested stateDiff is null.
  [Compare responses](../cases/a/control-storage-after-many.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^control-storage-after-many$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `control-storage-after-many`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/control-storage-after-many.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^control-storage-after-many$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-unknown-field`: Unrequested vmTrace is null.
  [Compare responses](../cases/a/call-unknown-field.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-unknown-field$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-unknown-field`: Unrequested stateDiff is null.
  [Compare responses](../cases/a/call-unknown-field.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-unknown-field$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-unknown-field`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/call-unknown-field.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-unknown-field$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-valid`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/raw-valid.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-valid$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-nonce-high`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/raw-nonce-high.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-nonce-high$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-wrong-chain`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/raw-wrong-chain.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-wrong-chain$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-insufficient-funds`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/raw-insufficient-funds.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-insufficient-funds$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-low-gas`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/raw-low-gas.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-low-gas$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-below-basefee`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/raw-below-basefee.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-below-basefee$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `auth-set`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/auth-set.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-set$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `auth-replace`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/auth-replace.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-replace$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `auth-clear`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/auth-clear.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-clear$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `auth-set-revert`: Output remains a byte string under every trace selection.
  [Compare responses](../cases/a/auth-set-revert.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-set-revert$" --output runs/reproduce`
...
- **change_needed** · `precompiles-final` / `nested-callcode-value1-failed`: A handled precompile failure must not mark the successful parent as failed.
  [Compare responses](../cases/precompiles/nested-callcode-value1-failed.md) · [Raw responses](../../evidence/2026-09-21/precompiles-final/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^nested-callcode-value1-failed$" --output runs/reproduce`
- **change_needed** · `verified-a-besu-retry` / `call-siblings-revert-ok`: The successful second sibling retains its output and has no error.
  [Compare responses](../cases/a/call-siblings-revert-ok.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-siblings-revert-ok$" --output runs/reproduce`
...
- **matches** · `precompiles-final` / `nested-callcode-value1-success`: Successful creation uses address, code and gasUsed.
  [Compare responses](../cases/precompiles/nested-callcode-value1-success.md) · [Raw responses](../../evidence/2026-09-21/precompiles-final/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^nested-callcode-value1-success$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-mixed-create`: Successful creation uses address, code and gasUsed.
  [Compare responses](../cases/a/call-mixed-create.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-mixed-create$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-mixed-create`: Successful creation uses address, code and gasUsed.
  [Compare responses](../cases/a/call-mixed-create.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
...
- **matches** · `precompiles-final` / `root-failed`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/precompiles/root-failed.md) · [Raw responses](../../evidence/2026-09-21/precompiles-final/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^root-failed$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-return42`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/call-return42.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-return42$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-siblings-ok-revert`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/call-siblings-ok-revert.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-siblings-ok-revert$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-siblings-revert-ok`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/call-siblings-revert-ok.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-siblings-revert-ok$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-mixed-create`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/call-mixed-create.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-mixed-create$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-gas7400`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/call-gas7400.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-gas7400$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-mcopy`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/call-mcopy.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-mcopy$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-destroy`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/call-destroy.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-destroy$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `vm-only-nonempty-output`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/vm-only-nonempty-output.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^vm-only-nonempty-output$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `prefunded-empty`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/prefunded-empty.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^prefunded-empty$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-valid`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/raw-valid.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-valid$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-nonce-high`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/raw-nonce-high.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-nonce-high$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-wrong-chain`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/raw-wrong-chain.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-wrong-chain$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-insufficient-funds`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/raw-insufficient-funds.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-insufficient-funds$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-low-gas`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/raw-low-gas.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-low-gas$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-below-basefee`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/raw-below-basefee.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-below-basefee$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `auth-set`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/auth-set.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-set$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `auth-replace`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/auth-replace.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-replace$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `auth-clear`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/auth-clear.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-clear$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `auth-set-revert`: Stack words use minimal hex quantities at every depth.
  [Compare responses](../cases/a/auth-set-revert.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-set-revert$" --output runs/reproduce`
...
- **change_needed** · `precompiles-final` / `root-failed`: A failed root precompile reports its own execution error.
  [Compare responses](../cases/precompiles/root-failed.md) · [Raw responses](../../evidence/2026-09-21/precompiles-final/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients besu_release --corpus precompiles --case "^root-failed$" --output runs/reproduce`
- **change_needed** · `verified-a-besu-retry` / `transaction-tree`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  [Compare responses](../cases/a/transaction-tree.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^transaction-tree$" --output runs/reproduce`
- **change_needed** · `verified-a-besu-retry` / `call-siblings-ok-revert`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  [Compare responses](../cases/a/call-siblings-ok-revert.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-siblings-ok-revert$" --output runs/reproduce`
- **change_needed** · `verified-a-besu-retry` / `call-siblings-revert-ok`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  [Compare responses](../cases/a/call-siblings-revert-ok.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-siblings-revert-ok$" --output runs/reproduce`
- **change_needed** · `verified-a-besu-retry` / `auth-replace`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  [Compare responses](../cases/a/auth-replace.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-replace$" --output runs/reproduce`
- **change_needed** · `verified-a-besu-retry` / `auth-set-revert`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  [Compare responses](../cases/a/auth-set-revert.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-set-revert$" --output runs/reproduce`
- **change_needed** · `verified-a-besu-retry` / `block-2`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  [Compare responses](../cases/a/block-2.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^block-2$" --output runs/reproduce`
...
- **matches** · `verified-a-besu-retry` / `get-nested-positive`: Return the transaction-tree record at [6, 0], or null if absent. Compared with the same client and transaction; precompile inclusion can shift sibling indexes.
  [Compare responses](../cases/a/get-nested-positive.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^get-nested-positive$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `get-nested-parent`: Return the transaction-tree record at [6], or null if absent. Compared with the same client and transaction; precompile inclusion can shift sibling indexes.
  [Compare responses](../cases/a/get-nested-parent.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^get-nested-parent$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `get-nested`: Return the transaction-tree record at [0, 0], or null if absent. Compared with the same client and transaction; precompile inclusion can shift sibling indexes.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients besu_release --corpus initial --case "^get-nested$" --output runs/reproduce`
...
- **matches** · `verified-a-besu-retry` / `get-path-wrong-type`: Malformed input returns invalid params (-32602).
  [Compare responses](../cases/a/get-path-wrong-type.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^get-path-wrong-type$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-wrong-type`: Malformed input returns invalid params (-32602).
  [Compare responses](../cases/a/call-wrong-type.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-wrong-type$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-unknown-mode`: Malformed input returns invalid params (-32602).
  [Compare responses](../cases/a/call-unknown-mode.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-unknown-mode$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `call-scalar-mode`: Malformed input returns invalid params (-32602).
  [Compare responses](../cases/a/call-scalar-mode.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-scalar-mode$" --output runs/reproduce`
...
- **matches** · `verified-a-besu-retry` / `filter-all`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 14 records from this client's block trace.
  [Compare responses](../cases/a/filter-all.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^filter-all$" --output runs/reproduce`
...
- **change_needed** · `verified-a-besu-retry` / `filter-from-empty-to-set`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 2 records from this client's block trace.
  [Compare responses](../cases/a/filter-from-empty-to-set.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^filter-from-empty-to-set$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `filter-to-empty-from-set`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 5 records from this client's block trace.
  [Compare responses](../cases/a/filter-to-empty-from-set.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^filter-to-empty-from-set$" --output runs/reproduce`
...
- **change_needed** · `verified-a-besu-retry` / `filter-created-to`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 1 records from this client's block trace.
  [Compare responses](../cases/a/filter-created-to.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^filter-created-to$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `filter-creator-from`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 7 records from this client's block trace.
  [Compare responses](../cases/a/filter-creator-from.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^filter-creator-from$" --output runs/reproduce`
- **change_needed** · `verified-a-besu-retry` / `filter-suicide-from`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 1 records from this client's block trace.
  [Compare responses](../cases/a/filter-suicide-from.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^filter-suicide-from$" --output runs/reproduce`
- **change_needed** · `verified-a-besu-retry` / `filter-suicide-beneficiary`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 2 records from this client's block trace.
  [Compare responses](../cases/a/filter-suicide-beneficiary.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^filter-suicide-beneficiary$" --output runs/reproduce`

</details>

<details><summary>H20: 2 assertion checks</summary>

- **change_needed** · `verified-a-besu-retry` / `call-mcopy`: MCOPY reports its same-step write of word 42 at offset 32.
  [Compare responses](../cases/a/call-mcopy.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^call-mcopy$" --output runs/reproduce`
...
- **matches** · `verified-a-besu-retry` / `prefunded-empty`: An existing prefunded account does not acquire creation markers for empty code or zero nonce.
  [Compare responses](../cases/a/prefunded-empty.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^prefunded-empty$" --output runs/reproduce`
...
- **matches** · `verified-a-besu-retry` / `empty-types`: An empty trace-type selection executes successfully.
  [Compare responses](../cases/a/empty-types.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^empty-types$" --output runs/reproduce`
...
- **matches** · `verified-a-besu-retry` / `many-storage-write-revert-read`: Sequential calls retain prior writes and roll back reverted writes.
  [Compare responses](../cases/a/many-storage-write-revert-read.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^many-storage-write-revert-read$" --output runs/reproduce`
...
- **matches** · `verified-a-besu-retry` / `raw-valid`: Return one complete JSON-RPC response, including on validation failure.
  [Compare responses](../cases/a/raw-valid.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-valid$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-nonce-high`: Return one complete JSON-RPC response, including on validation failure.
  [Compare responses](../cases/a/raw-nonce-high.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-nonce-high$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-wrong-chain`: Return one complete JSON-RPC response, including on validation failure.
  [Compare responses](../cases/a/raw-wrong-chain.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-wrong-chain$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-insufficient-funds`: Return one complete JSON-RPC response, including on validation failure.
  [Compare responses](../cases/a/raw-insufficient-funds.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-insufficient-funds$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-low-gas`: Return one complete JSON-RPC response, including on validation failure.
  [Compare responses](../cases/a/raw-low-gas.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-low-gas$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `raw-below-basefee`: Return one complete JSON-RPC response, including on validation failure.
  [Compare responses](../cases/a/raw-below-basefee.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-below-basefee$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `auth-set`: Return one complete JSON-RPC response, including on validation failure.
  [Compare responses](../cases/a/auth-set.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-set$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `auth-replace`: Return one complete JSON-RPC response, including on validation failure.
  [Compare responses](../cases/a/auth-replace.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-replace$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `auth-clear`: Return one complete JSON-RPC response, including on validation failure.
  [Compare responses](../cases/a/auth-clear.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-clear$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `auth-set-revert`: Return one complete JSON-RPC response, including on validation failure.
  [Compare responses](../cases/a/auth-set-revert.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-set-revert$" --output runs/reproduce`
...
- **change_needed** · `verified-a-besu-retry` / `raw-nonce-high`: A signed nonce mismatch is rejected rather than replaced.
  [Compare responses](../cases/a/raw-nonce-high.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^raw-nonce-high$" --output runs/reproduce`
...
- **matches** · `verified-a-besu-retry` / `auth-set`: EIP-7702 reports the actual delegation-code transition, including clear and changes surviving execution revert.
  [Compare responses](../cases/a/auth-set.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-set$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `auth-replace`: EIP-7702 reports the actual delegation-code transition, including clear and changes surviving execution revert.
  [Compare responses](../cases/a/auth-replace.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-replace$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `auth-clear`: EIP-7702 reports the actual delegation-code transition, including clear and changes surviving execution revert.
  [Compare responses](../cases/a/auth-clear.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-clear$" --output runs/reproduce`
- **matches** · `verified-a-besu-retry` / `auth-set-revert`: EIP-7702 reports the actual delegation-code transition, including clear and changes surviving execution revert.
  [Compare responses](../cases/a/auth-set-revert.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^auth-set-revert$" --output runs/reproduce`
...
- **change_needed** · `verified-a-besu-retry` / `block-2`: A PoS block has no synthetic PoW reward records.
  [Compare responses](../cases/a/block-2.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^block-2$" --output runs/reproduce`
- **change_needed** · `verified-a-besu-retry` / `block-3`: A PoS block has no synthetic PoW reward records.
  [Compare responses](../cases/a/block-3.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^block-3$" --output runs/reproduce`
...
- **matches** · `verified-a-besu-retry` / `filter-two-blocks`: Range traces equal concatenated per-block traces in canonical order.
  [Compare responses](../cases/a/filter-two-blocks.md) · [Raw responses](../../evidence/2026-09-21/verified-a-besu-retry/observations.json).
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a-besu-retry/manifest.json --clients besu_release --corpus a --case "^filter-two-blocks$" --output runs/reproduce`
