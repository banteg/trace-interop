...
- **matches** · `verified-a-besu-retry` / `get-nested-positive`: Return one object whose traceAddress equals [6, 0]. Observed [6, 0].
...
- **matches** · `verified-a-besu-retry` / `get-nested-parent`: Return one object whose traceAddress equals [6]. Observed [6].
