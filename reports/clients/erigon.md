...
| [Signed transaction nonce validation](../decisions/H13.md)<br>A signed transaction with a nonce above the account nonce is accepted. | Differs<br>[Raw nonce high](../cases/a/raw-nonce-high.md) | Differs<br>[Raw nonce high](../cases/a/raw-nonce-high.md) | If the proposed admission policy is adopted, reject nonce mismatches without rewriting the signed nonce. This is a contract decision, separate from well-formed error reporting.<br>[Signed transaction replay](https://github.com/erigontech/erigon/blob/c25b8e47dc1a77ecdbd15d38ba3beae1d29530ec/rpc/jsonrpc/trace_adhoc.go#L1656) |
