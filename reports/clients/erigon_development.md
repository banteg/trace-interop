...
| [Unsigned simulation fees and block environment](../decisions/H15.md)<br>eth_call uses BASEFEE 0 for explicit zero fees and debits priced gas upfront. trace_call rejects legacy zero, reprices typed zero to B, changes GASLIMIT and skips the sender gas debit; its stateDiff still credits tips. Both methods reject positive legacy/typed caps below B. | ⚠️ Differs<br>120 policy-open cases.<br>[Model environment](../cases/coverage/model-environment.md) | Match eth_call for explicit zero fees with BASEFEE zero. Preserve other block fields; enforce positive-price funding and simulate sender debit, refunds and beneficiary tips consistently.<br>[Call simulation](https://github.com/erigontech/erigon/blob/e26d9bd4056586e004488c31b561fb2663d46019/rpc/jsonrpc/trace_adhoc.go#L1096) |
