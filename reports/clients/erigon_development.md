# erigon_development: proposed changes

Tested builds: `3.8.0-dev-c25b8e47`.
...
| [H02 — trace_get selector and return shape](../decisions/H02.md) | 10 matches | No change identified by these checks. |
...
| [H06 — Missing transactions and paths](../decisions/H06.md) | 10 matches | No change identified by these checks. |
| [H07 — Replay transactionHash field](../decisions/H07.md) | 24 matches | No change identified by these checks. |
| [H08 — Empty output and unrequested components](../decisions/H08.md) | 213 matches | No change identified by these checks. |
...
| [H11 — Empty trace-type selection](../decisions/H11.md) | 2 change needed, 3 matches | An empty trace-type selection executes successfully. |
...
- **matches** · `initial` / `transaction-tree`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^transaction-tree$" --output runs/reproduce`
- **matches** · `initial` / `replay-tree-trace`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^replay-tree-trace$" --output runs/reproduce`
- **matches** · `initial` / `transaction-revert`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^transaction-revert$" --output runs/reproduce`
- **matches** · `initial` / `replay-revert-trace`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^replay-revert-trace$" --output runs/reproduce`
- **matches** · `initial` / `block-tree`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^block-tree$" --output runs/reproduce`
- **matches** · `initial` / `call-tree-trace-priced`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^call-tree-trace-priced$" --output runs/reproduce`
- **matches** · `verified-a` / `transaction-tree`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^transaction-tree$" --output runs/reproduce`
- **matches** · `verified-a` / `call-siblings-ok-revert`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^call-siblings-ok-revert$" --output runs/reproduce`
- **matches** · `verified-a` / `call-siblings-revert-ok`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^call-siblings-revert-ok$" --output runs/reproduce`
- **matches** · `verified-a` / `auth-replace`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^auth-replace$" --output runs/reproduce`
- **matches** · `verified-a` / `auth-set-revert`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^auth-set-revert$" --output runs/reproduce`
- **matches** · `verified-a` / `block-2`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^block-2$" --output runs/reproduce`
- **matches** · `verified-fork-followup` / `beacon-call-55`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-fork-followup/manifest.json --clients erigon_development --corpus fork-followup --case "^beacon-call-55$" --output runs/reproduce`
- **matches** · `verified-forks` / `block-36`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^block-36$" --output runs/reproduce`
- **matches** · `verified-forks` / `block-48`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^block-48$" --output runs/reproduce`
- **matches** · `verified-forks` / `block-51`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^block-51$" --output runs/reproduce`
- **matches** · `verified-forks` / `block-60`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^block-60$" --output runs/reproduce`
- **matches** · `verified-forks` / `mcopy-trace-55`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^mcopy-trace-55$" --output runs/reproduce`
- **matches** · `verified-initial` / `transaction-tree`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^transaction-tree$" --output runs/reproduce`
- **matches** · `verified-initial` / `replay-tree-trace`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^replay-tree-trace$" --output runs/reproduce`
- **matches** · `verified-initial` / `transaction-revert`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^transaction-revert$" --output runs/reproduce`
- **matches** · `verified-initial` / `replay-revert-trace`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^replay-revert-trace$" --output runs/reproduce`
- **matches** · `verified-initial` / `block-tree`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^block-tree$" --output runs/reproduce`
- **matches** · `verified-initial` / `call-tree-trace-priced`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^call-tree-trace-priced$" --output runs/reproduce`
- **matches** · `verified-repeat` / `call-siblings-revert-ok`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^call-siblings-revert-ok$" --output runs/reproduce`
- **matches** · `verified-repeat` / `auth-set-revert`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^auth-set-revert$" --output runs/reproduce`
...
- **matches** · `initial` / `replay-tree-stateDiff`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^replay-tree-stateDiff$" --output runs/reproduce`
- **matches** · `initial` / `replay-tree-vmTrace`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^replay-tree-vmTrace$" --output runs/reproduce`
...
- **matches** · `initial` / `replay-revert-stateDiff`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^replay-revert-stateDiff$" --output runs/reproduce`
- **matches** · `initial` / `replay-revert-vmTrace`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^replay-revert-vmTrace$" --output runs/reproduce`
- **matches** · `initial` / `replay-7702-trace`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^replay-7702-trace$" --output runs/reproduce`
- **matches** · `initial` / `replay-7702-stateDiff`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^replay-7702-stateDiff$" --output runs/reproduce`
- **matches** · `initial` / `replay-7702-vmTrace`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^replay-7702-vmTrace$" --output runs/reproduce`
- **matches** · `initial` / `replay-transfer-trace`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^replay-transfer-trace$" --output runs/reproduce`
- **matches** · `initial` / `replay-transfer-stateDiff`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^replay-transfer-stateDiff$" --output runs/reproduce`
- **matches** · `initial` / `replay-transfer-vmTrace`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^replay-transfer-vmTrace$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `replay-tree-stateDiff`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^replay-tree-stateDiff$" --output runs/reproduce`
- **matches** · `verified-initial` / `replay-tree-vmTrace`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^replay-tree-vmTrace$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `replay-revert-stateDiff`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^replay-revert-stateDiff$" --output runs/reproduce`
- **matches** · `verified-initial` / `replay-revert-vmTrace`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^replay-revert-vmTrace$" --output runs/reproduce`
- **matches** · `verified-initial` / `replay-7702-trace`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^replay-7702-trace$" --output runs/reproduce`
- **matches** · `verified-initial` / `replay-7702-stateDiff`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^replay-7702-stateDiff$" --output runs/reproduce`
- **matches** · `verified-initial` / `replay-7702-vmTrace`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^replay-7702-vmTrace$" --output runs/reproduce`
- **matches** · `verified-initial` / `replay-transfer-trace`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^replay-transfer-trace$" --output runs/reproduce`
- **matches** · `verified-initial` / `replay-transfer-stateDiff`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^replay-transfer-stateDiff$" --output runs/reproduce`
- **matches** · `verified-initial` / `replay-transfer-vmTrace`: Individual replay includes its transactionHash.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^replay-transfer-vmTrace$" --output runs/reproduce`

</details>

<details><summary>H08: 213 assertion checks</summary>
...
- **matches** · `initial` / `call-tree-stateDiff-priced`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^call-tree-stateDiff-priced$" --output runs/reproduce`
...
- **matches** · `initial` / `call-tree-vmTrace-priced`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^call-tree-vmTrace-priced$" --output runs/reproduce`
...
- **matches** · `initial` / `call-empty-types-priced`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^call-empty-types-priced$" --output runs/reproduce`
...
- **matches** · `initial` / `call-constructor-priced`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^call-constructor-priced$" --output runs/reproduce`
- **matches** · `initial` / `raw-valid-default-block`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^raw-valid-default-block$" --output runs/reproduce`
- **matches** · `initial` / `raw-valid-current-nonce`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^raw-valid-current-nonce$" --output runs/reproduce`
- **matches** · `initial` / `call-transfer-trace`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^call-transfer-trace$" --output runs/reproduce`
...
- **matches** · `initial` / `call-transfer-stateDiff`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^call-transfer-stateDiff$" --output runs/reproduce`
...
- **matches** · `initial` / `call-transfer-vmTrace`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^call-transfer-vmTrace$" --output runs/reproduce`
...
- **matches** · `initial` / `call-identity`: Unrequested stateDiff is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^call-identity$" --output runs/reproduce`
...
- **matches** · `verified-a` / `call-return42`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^call-return42$" --output runs/reproduce`
...
- **matches** · `verified-a` / `call-mixed-create`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^call-mixed-create$" --output runs/reproduce`
- **matches** · `verified-a` / `call-gas7400`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^call-gas7400$" --output runs/reproduce`
- **matches** · `verified-a` / `call-mcopy`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^call-mcopy$" --output runs/reproduce`
- **matches** · `verified-a` / `call-destroy`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^call-destroy$" --output runs/reproduce`
- **matches** · `verified-a` / `state-only-nonempty-output`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^state-only-nonempty-output$" --output runs/reproduce`
...
- **matches** · `verified-a` / `vm-only-nonempty-output`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^vm-only-nonempty-output$" --output runs/reproduce`
...
- **matches** · `verified-a` / `prefunded-empty`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^prefunded-empty$" --output runs/reproduce`
- **matches** · `verified-a` / `empty-types`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^empty-types$" --output runs/reproduce`
...
- **matches** · `verified-a` / `control-storage-after-many`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^control-storage-after-many$" --output runs/reproduce`
...
- **matches** · `verified-a` / `call-unknown-field`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^call-unknown-field$" --output runs/reproduce`
...
- **matches** · `verified-a` / `raw-valid`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^raw-valid$" --output runs/reproduce`
- **matches** · `verified-a` / `raw-nonce-high`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^raw-nonce-high$" --output runs/reproduce`
- **matches** · `verified-a` / `raw-insufficient-funds`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^raw-insufficient-funds$" --output runs/reproduce`
- **matches** · `verified-a` / `auth-set`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^auth-set$" --output runs/reproduce`
...
- **matches** · `verified-a` / `auth-clear`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^auth-clear$" --output runs/reproduce`
...
- **matches** · `verified-fork-followup` / `destroy-trace-55`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-fork-followup/manifest.json --clients erigon_development --corpus fork-followup --case "^destroy-trace-55$" --output runs/reproduce`
- **matches** · `verified-fork-followup` / `destroy-trace-56`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-fork-followup/manifest.json --clients erigon_development --corpus fork-followup --case "^destroy-trace-56$" --output runs/reproduce`
...
- **matches** · `verified-fork-followup` / `beacon-call-56`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-fork-followup/manifest.json --clients erigon_development --corpus fork-followup --case "^beacon-call-56$" --output runs/reproduce`
...
- **matches** · `verified-forks` / `destroy-trace-55`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^destroy-trace-55$" --output runs/reproduce`
...
- **matches** · `verified-forks` / `destroy-trace-56`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^destroy-trace-56$" --output runs/reproduce`
- **matches** · `verified-forks` / `mcopy-trace-56`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^mcopy-trace-56$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-tree-stateDiff-priced`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^call-tree-stateDiff-priced$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-tree-vmTrace-priced`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^call-tree-vmTrace-priced$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-empty-types-priced`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^call-empty-types-priced$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-constructor-priced`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^call-constructor-priced$" --output runs/reproduce`
- **matches** · `verified-initial` / `raw-valid-default-block`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^raw-valid-default-block$" --output runs/reproduce`
- **matches** · `verified-initial` / `raw-valid-current-nonce`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^raw-valid-current-nonce$" --output runs/reproduce`
- **matches** · `verified-initial` / `call-transfer-trace`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^call-transfer-trace$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-transfer-stateDiff`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^call-transfer-stateDiff$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-transfer-vmTrace`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^call-transfer-vmTrace$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-identity`: Unrequested stateDiff is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^call-identity$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `call-return42`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^call-return42$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `call-mixed-create`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^call-mixed-create$" --output runs/reproduce`
- **matches** · `verified-repeat` / `call-gas7400`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^call-gas7400$" --output runs/reproduce`
- **matches** · `verified-repeat` / `call-mcopy`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^call-mcopy$" --output runs/reproduce`
- **matches** · `verified-repeat` / `state-only-nonempty-output`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^state-only-nonempty-output$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-valid`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-valid$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-nonce-high`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-nonce-high$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-insufficient-funds`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-insufficient-funds$" --output runs/reproduce`
- **matches** · `verified-repeat` / `auth-clear`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^auth-clear$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-valid-trace`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-valid-trace$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-valid-stateDiff`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-valid-stateDiff$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-valid-vmTrace`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-valid-vmTrace$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-nonce-high-trace`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-nonce-high-trace$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-nonce-high-stateDiff`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-nonce-high-stateDiff$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-nonce-high-vmTrace`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-nonce-high-vmTrace$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-insufficient-funds-trace`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-insufficient-funds-trace$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-insufficient-funds-stateDiff`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-insufficient-funds-stateDiff$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-insufficient-funds-vmTrace`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-insufficient-funds-vmTrace$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `constructor`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^constructor$" --output runs/reproduce`
...
- **matches** · `initial` / `block-transfer`: A PoS block has no synthetic PoW reward records.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^block-transfer$" --output runs/reproduce`
...
- **matches** · `verified-a` / `block-3`: A PoS block has no synthetic PoW reward records.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^block-3$" --output runs/reproduce`
...
- **matches** · `verified-forks` / `block-52`: A PoS block has no synthetic PoW reward records.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^block-52$" --output runs/reproduce`
- **matches** · `verified-forks` / `block-55`: A PoS block has no synthetic PoW reward records.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^block-55$" --output runs/reproduce`
- **matches** · `verified-forks` / `block-56`: A PoS block has no synthetic PoW reward records.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^block-56$" --output runs/reproduce`
- **matches** · `verified-forks` / `block-59`: A PoS block has no synthetic PoW reward records.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^block-59$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `block-transfer`: A PoS block has no synthetic PoW reward records.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^block-transfer$" --output runs/reproduce`
...
- **matches** · `initial` / `get-root`: Return one object whose traceAddress equals []. Observed [].
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^get-root$" --output runs/reproduce`
- **matches** · `initial` / `get-zero`: Return one object whose traceAddress equals [0]. Observed [0].
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^get-zero$" --output runs/reproduce`
- **matches** · `initial` / `get-one`: Return one object whose traceAddress equals [1]. Observed [1].
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^get-one$" --output runs/reproduce`
- **matches** · `initial` / `get-transfer-root`: Return one object whose traceAddress equals []. Observed [].
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^get-transfer-root$" --output runs/reproduce`
- **matches** · `verified-a` / `get-nested-positive`: Return one object whose traceAddress equals [6, 0]. Observed [6, 0].
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^get-nested-positive$" --output runs/reproduce`
- **matches** · `verified-a` / `get-nested-parent`: Return one object whose traceAddress equals [6]. Observed [6].
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^get-nested-parent$" --output runs/reproduce`
- **matches** · `verified-initial` / `get-root`: Return one object whose traceAddress equals []. Observed [].
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^get-root$" --output runs/reproduce`
- **matches** · `verified-initial` / `get-zero`: Return one object whose traceAddress equals [0]. Observed [0].
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^get-zero$" --output runs/reproduce`
- **matches** · `verified-initial` / `get-one`: Return one object whose traceAddress equals [1]. Observed [1].
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^get-one$" --output runs/reproduce`
- **matches** · `verified-initial` / `get-transfer-root`: Return one object whose traceAddress equals []. Observed [].
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^get-transfer-root$" --output runs/reproduce`
...
- **matches** · `initial` / `get-missing`: A missing transaction or tree path returns null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^get-missing$" --output runs/reproduce`
- **matches** · `initial` / `transaction-missing`: Unknown transaction returns null, not an empty collection or RPC error.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^transaction-missing$" --output runs/reproduce`
- **matches** · `initial` / `replay-missing`: Unknown transaction returns null, not an empty collection or RPC error.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^replay-missing$" --output runs/reproduce`
- **matches** · `initial` / `get-missing-tx`: A missing transaction or tree path returns null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^get-missing-tx$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `get-missing`: A missing transaction or tree path returns null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^get-missing$" --output runs/reproduce`
- **matches** · `verified-initial` / `transaction-missing`: Unknown transaction returns null, not an empty collection or RPC error.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^transaction-missing$" --output runs/reproduce`
- **matches** · `verified-initial` / `replay-missing`: Unknown transaction returns null, not an empty collection or RPC error.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^replay-missing$" --output runs/reproduce`
- **matches** · `verified-initial` / `get-missing-tx`: A missing transaction or tree path returns null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^get-missing-tx$" --output runs/reproduce`
...
- **matches** · `initial` / `filter-all`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 13 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^filter-all$" --output runs/reproduce`
- **matches** · `initial` / `filter-from`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 5 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^filter-from$" --output runs/reproduce`
- **matches** · `initial` / `filter-to`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 2 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^filter-to$" --output runs/reproduce`
- **change_needed** · `initial` / `filter-both`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 1 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^filter-both$" --output runs/reproduce`
- **matches** · `verified-a` / `filter-all`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 13 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^filter-all$" --output runs/reproduce`
- **matches** · `verified-initial` / `filter-all`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 13 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^filter-all$" --output runs/reproduce`
- **matches** · `verified-initial` / `filter-from`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 5 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^filter-from$" --output runs/reproduce`
- **matches** · `verified-initial` / `filter-to`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 2 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^filter-to$" --output runs/reproduce`
- **change_needed** · `verified-initial` / `filter-both`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 1 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^filter-both$" --output runs/reproduce`
...
- **matches** · `initial` / `filter-empty`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 13 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^filter-empty$" --output runs/reproduce`
- **matches** · `verified-a` / `filter-from-empty-to-set`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 2 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^filter-from-empty-to-set$" --output runs/reproduce`
- **matches** · `verified-a` / `filter-to-empty-from-set`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 5 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^filter-to-empty-from-set$" --output runs/reproduce`
- **matches** · `verified-initial` / `filter-empty`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 13 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^filter-empty$" --output runs/reproduce`
...
- **change_needed** · `initial` / `call-tree-trace`: Explicit zero-fee unsigned execution is accepted; block-environment preservation needs additional checks.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^call-tree-trace$" --output runs/reproduce`
- **change_needed** · `initial` / `call-tree-stateDiff`: Explicit zero-fee unsigned execution is accepted; block-environment preservation needs additional checks.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^call-tree-stateDiff$" --output runs/reproduce`
- **change_needed** · `initial` / `call-tree-vmTrace`: Explicit zero-fee unsigned execution is accepted; block-environment preservation needs additional checks.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^call-tree-vmTrace$" --output runs/reproduce`
- **change_needed** · `initial` / `call-empty-types`: Explicit zero-fee unsigned execution is accepted; block-environment preservation needs additional checks.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^call-empty-types$" --output runs/reproduce`
- **change_needed** · `initial` / `call-constructor`: Explicit zero-fee unsigned execution is accepted; block-environment preservation needs additional checks.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^call-constructor$" --output runs/reproduce`
- **change_needed** · `verified-initial` / `call-tree-trace`: Explicit zero-fee unsigned execution is accepted; block-environment preservation needs additional checks.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^call-tree-trace$" --output runs/reproduce`
- **change_needed** · `verified-initial` / `call-tree-stateDiff`: Explicit zero-fee unsigned execution is accepted; block-environment preservation needs additional checks.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^call-tree-stateDiff$" --output runs/reproduce`
- **change_needed** · `verified-initial` / `call-tree-vmTrace`: Explicit zero-fee unsigned execution is accepted; block-environment preservation needs additional checks.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^call-tree-vmTrace$" --output runs/reproduce`
- **change_needed** · `verified-initial` / `call-empty-types`: Explicit zero-fee unsigned execution is accepted; block-environment preservation needs additional checks.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^call-empty-types$" --output runs/reproduce`
- **change_needed** · `verified-initial` / `call-constructor`: Explicit zero-fee unsigned execution is accepted; block-environment preservation needs additional checks.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^call-constructor$" --output runs/reproduce`
...
- **matches** · `initial` / `raw-valid`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^raw-valid$" --output runs/reproduce`
- **matches** · `initial` / `raw-invalid`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/initial/manifest.json --clients erigon_development --corpus initial --case "^raw-invalid$" --output runs/reproduce`
...
- **matches** · `verified-a` / `raw-wrong-chain`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^raw-wrong-chain$" --output runs/reproduce`
...
- **matches** · `verified-a` / `raw-low-gas`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^raw-low-gas$" --output runs/reproduce`
- **matches** · `verified-a` / `raw-below-basefee`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^raw-below-basefee$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `raw-valid`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^raw-valid$" --output runs/reproduce`
- **matches** · `verified-initial` / `raw-invalid`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients erigon_development --corpus initial --case "^raw-invalid$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-wrong-chain`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-wrong-chain$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-low-gas`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-low-gas$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-below-basefee`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-below-basefee$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-wrong-chain-trace`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-wrong-chain-trace$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-wrong-chain-stateDiff`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-wrong-chain-stateDiff$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-wrong-chain-vmTrace`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-wrong-chain-vmTrace$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-low-gas-trace`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-low-gas-trace$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-low-gas-stateDiff`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-low-gas-stateDiff$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-low-gas-vmTrace`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-low-gas-vmTrace$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-below-basefee-trace`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-below-basefee-trace$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-below-basefee-stateDiff`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-below-basefee-stateDiff$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-below-basefee-vmTrace`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^raw-below-basefee-vmTrace$" --output runs/reproduce`
...
- **matches** · `verified-a` / `get-path-wrong-type`: Malformed input returns invalid params (-32602).
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^get-path-wrong-type$" --output runs/reproduce`
- **matches** · `verified-a` / `call-wrong-type`: Malformed input returns invalid params (-32602).
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^call-wrong-type$" --output runs/reproduce`
- **change_needed** · `verified-a` / `call-unknown-mode`: Malformed input returns invalid params (-32602).
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^call-unknown-mode$" --output runs/reproduce`
- **matches** · `verified-a` / `call-scalar-mode`: Malformed input returns invalid params (-32602).
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^call-scalar-mode$" --output runs/reproduce`
...
- **matches** · `verified-a` / `filter-created-to`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 1 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^filter-created-to$" --output runs/reproduce`
- **matches** · `verified-a` / `filter-creator-from`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 7 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^filter-creator-from$" --output runs/reproduce`
- **matches** · `verified-a` / `filter-suicide-from`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 1 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^filter-suicide-from$" --output runs/reproduce`
- **matches** · `verified-a` / `filter-suicide-beneficiary`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 2 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^filter-suicide-beneficiary$" --output runs/reproduce`
...
- **matches** · `verified-a` / `many-storage-write-revert-read`: Sequential calls retain prior writes and roll back reverted writes.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^many-storage-write-revert-read$" --output runs/reproduce`
- **matches** · `verified-repeat` / `many-storage-write-revert-read`: Sequential calls retain prior writes and roll back reverted writes.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients erigon_development --corpus repeat --case "^many-storage-write-revert-read$" --output runs/reproduce`
...
- **matches** · `verified-a` / `filter-two-blocks`: Range traces equal concatenated per-block traces in canonical order.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients erigon_development --corpus a --case "^filter-two-blocks$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-35`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^filter-35$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-36`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^filter-36$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-47`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^filter-47$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-48`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^filter-48$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-51`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^filter-51$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-52`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^filter-52$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-55`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^filter-55$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-56`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^filter-56$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-59`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^filter-59$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-60`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^filter-60$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-across-36`: A fork-crossing range equals the corresponding per-block traces.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^filter-across-36$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-across-48`: A fork-crossing range equals the corresponding per-block traces.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^filter-across-48$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-across-52`: A fork-crossing range equals the corresponding per-block traces.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^filter-across-52$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-across-56`: A fork-crossing range equals the corresponding per-block traces.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^filter-across-56$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-across-60`: A fork-crossing range equals the corresponding per-block traces.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^filter-across-60$" --output runs/reproduce`
...
- **matches** · `verified-fork-followup` / `system-beacon-55-560`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-fork-followup/manifest.json --clients erigon_development --corpus fork-followup --case "^system-beacon-55-560$" --output runs/reproduce`
- **matches** · `verified-fork-followup` / `system-beacon-55-8751`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-fork-followup/manifest.json --clients erigon_development --corpus fork-followup --case "^system-beacon-55-8751$" --output runs/reproduce`
- **matches** · `verified-fork-followup` / `system-beacon-56-560`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-fork-followup/manifest.json --clients erigon_development --corpus fork-followup --case "^system-beacon-56-560$" --output runs/reproduce`
- **matches** · `verified-fork-followup` / `system-beacon-56-8751`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-fork-followup/manifest.json --clients erigon_development --corpus fork-followup --case "^system-beacon-56-8751$" --output runs/reproduce`
...
- **matches** · `verified-forks` / `system-beacon-55-560`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^system-beacon-55-560$" --output runs/reproduce`
- **matches** · `verified-forks` / `system-beacon-55-8751`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^system-beacon-55-8751$" --output runs/reproduce`
- **matches** · `verified-forks` / `system-beacon-56-560`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^system-beacon-56-560$" --output runs/reproduce`
- **matches** · `verified-forks` / `system-beacon-56-8751`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^system-beacon-56-8751$" --output runs/reproduce`
- **matches** · `verified-forks` / `system-beacon-57-560`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^system-beacon-57-560$" --output runs/reproduce`
- **matches** · `verified-forks` / `system-beacon-57-8751`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients erigon_development --corpus forks --case "^system-beacon-57-8751$" --output runs/reproduce`
