...
| [H02 — trace_get selector and return shape](../decisions/H02.md) | 2 change needed, 2 matches | No specific change established by the historical summary; review the proposed rule and fresh evidence. This is not a pass verdict. |
| [H03 — Filter composition and mode](../decisions/H03.md) | 1 change needed, 3 matches | Change default union to intersection and avoid suppressing one-sided intersection queries. |
...
| [H06 — Missing transactions and paths](../decisions/H06.md) | 2 change needed, 3 matches | No specific change established by the historical summary; review the proposed rule and fresh evidence. This is not a pass verdict. |
...
| [H08 — Empty output and unrequested components](../decisions/H08.md) | 4 change needed, 55 matches | No specific change established by the historical summary; review the proposed rule and fresh evidence. This is not a pass verdict. |
| [H09 — Failed frame results and error labels](../decisions/H09.md) | 8 matches | No specific change established by the historical summary; review the proposed rule and fresh evidence. This is not a pass verdict. |
...
| [H11 — Empty trace-type selection](../decisions/H11.md) | 2 change needed | No specific change established by the historical summary; review the proposed rule and fresh evidence. This is not a pass verdict. |
| [H12 — Raw-transaction block argument](../decisions/H12.md) | 1 matches | Keep the two-argument baseline; document any block-selector extension. |
...
| [H21 — vmTrace numeric and optional metadata encoding](../decisions/H21.md) | 10 matches | Review stack word canonicalization; optional op/idx must not become mandatory for consumers. |
...
<details><summary>H09: 8 assertion checks</summary>
...
<details><summary>H08: 59 assertion checks</summary>
...
<details><summary>H21: 10 assertion checks</summary>
