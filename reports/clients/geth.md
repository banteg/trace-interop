...
**Progress on 1.17.7-unstable · 0a663f3c** (of 32 decisions): ✅ 26 agree · ⚠️ 1 with no fix yet · ❔ 3 policy open · ⚪ 2 not fully measured. Upstream fix PRs: 0 merged, 1 open ([client fixes](../../docs/client-fixes.md)).
