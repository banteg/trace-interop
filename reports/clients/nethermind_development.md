...
| [H02 — trace_get selector and return shape](../decisions/H02.md) | 10 change needed | Use one nested path and return a singular object/null instead of a list; this changes the response type. |
| [H03 — Filter composition and mode](../decisions/H03.md) | 9 matches | No change identified by these checks. |
| [H04 — Empty address lists](../decisions/H04.md) | 4 change needed | Treat [] address lists as unrestricted rather than matching nothing. |
| [H05 — Post-merge reward records](../decisions/H05.md) | 13 change needed | Remove synthetic zero PoW reward records on PoS blocks; pagination counts will change. |
| [H06 — Missing transactions and paths](../decisions/H06.md) | 10 change needed | Replace unknown-transaction/path exceptions with null; distinguish unavailable history. |
| [H07 — Replay transactionHash field](../decisions/H07.md) | 24 matches | No change identified by these checks. |
| [H08 — Empty output and unrequested components](../decisions/H08.md) | 20 change needed, 190 matches | Preserve actual output bytes when only stateDiff is selected; null loses nonempty output too. |
| [H09 — Failed frame results and error labels](../decisions/H09.md) | 28 change needed | Retain failed-frame result information where available instead of omitting result. |
| [H10 — Creation result field names](../decisions/H10.md) | 13 matches | No change identified by these checks. |
| [H11 — Empty trace-type selection](../decisions/H11.md) | 5 change needed | Accept empty trace selections without an internal reduction exception. |
...
| [H14 — Invalid-parameter error codes](../decisions/H14.md) | 2 change needed, 4 matches | Normalize malformed input to -32602 and separate it from valid-but-rejected transactions; code changes affect consumers. |
| [H15 — Unsigned simulation fees and block environment](../decisions/H15.md) | 2 change needed, 8 matches | Review zero-fee unsigned calls without changing BASEFEE; fee admission and opcode context need separate checks. |
...
| [H19 — vmTrace executing bytecode](../decisions/H19.md) | 5 matches | No change identified by these checks. |
| [H20 — vmTrace step timing and deltas](../decisions/H20.md) | 2 matches | No change identified by these checks. |
| [H21 — vmTrace numeric and optional metadata encoding](../decisions/H21.md) | 31 change needed, 26 matches | Review stack word canonicalization; optional op/idx must not become mandatory for consumers. |
...
| [H25 — Well-formed errors for rejected raw transactions](../decisions/H25.md) | 20 change needed, 24 matches | Avoid partial/malformed JSON when signed-transaction validation fails. |
...
<details><summary>H08: 210 assertion checks</summary>
...
<details><summary>H21: 57 assertion checks</summary>
