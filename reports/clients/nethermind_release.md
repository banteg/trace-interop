...
| [H02 — trace_get selector and return shape](../decisions/H02.md) | Not asserted / needs review | Use one nested path and return a singular object/null instead of a list; this changes the response type. |
...
| [H04 — Empty address lists](../decisions/H04.md) | Not asserted / needs review | Treat [] address lists as unrestricted rather than matching nothing. |
...
| [H06 — Missing transactions and paths](../decisions/H06.md) | Not asserted / needs review | Replace unknown-transaction/path exceptions with null; distinguish unavailable history. |
...
| [H08 — Empty output and unrequested components](../decisions/H08.md) | Not asserted / needs review | Preserve actual output bytes when only stateDiff is selected; null loses nonempty output too. |
| [H09 — Failed frame results and error labels](../decisions/H09.md) | Not asserted / needs review | Retain failed-frame result information where available instead of omitting result. |
| [H10 — Creation result field names](../decisions/H10.md) | Not asserted / needs review | Review creation output field names against address/code/gasUsed. |
| [H11 — Empty trace-type selection](../decisions/H11.md) | Not asserted / needs review | Accept empty trace selections without an internal reduction exception. |
...
| [H25 — Well-formed errors for rejected raw transactions](../decisions/H25.md) | Not asserted / needs review | Avoid partial/malformed JSON when signed-transaction validation fails. |
