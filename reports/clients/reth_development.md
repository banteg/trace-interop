...
| [Filter composition and mode](../decisions/H03.md)<br>Sender and recipient lists are combined with OR by default. | Differs<br>[Filter both](../cases/initial/filter-both.md) | Use AND between lists by default so a second filter narrows the search; preserve union as an explicit mode.<br>[Address filtering](https://github.com/paradigmxyz/reth/blob/03cb186c1d36eebbacc7bda08f36e25711d0804e/crates/rpc/rpc/src/trace.rs#L363) |
