...
| [H02 — trace_get selector and return shape](../decisions/H02.md) | 6 change needed | Replace flat/offset selection with one traceAddress path; [] must select root. Existing callers may depend on old indexing. |
...
| [H08 — Empty output and unrequested components](../decisions/H08.md) | 145 matches | No change identified by these checks. |
| [H09 — Failed frame results and error labels](../decisions/H09.md) | 21 matches | No change identified by these checks. |
...
| [H21 — vmTrace numeric and optional metadata encoding](../decisions/H21.md) | 42 matches | No change identified by these checks. |
...
<details><summary>H08: 145 assertion checks</summary>
...
<details><summary>H21: 42 assertion checks</summary>
