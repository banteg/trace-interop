...
Tested builds: `Reth Version: 2.6.0+73a3a008`.
...
- **matches** · `precompiles-final` / `nested-call-value0-success`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients reth_release --corpus precompiles --case "^nested-call-value0-success$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-call-value0-failed`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients reth_release --corpus precompiles --case "^nested-call-value0-failed$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-call-value1-success`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients reth_release --corpus precompiles --case "^nested-call-value1-success$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-call-value1-failed`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients reth_release --corpus precompiles --case "^nested-call-value1-failed$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-staticcall-value0-success`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients reth_release --corpus precompiles --case "^nested-staticcall-value0-success$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-staticcall-value0-failed`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients reth_release --corpus precompiles --case "^nested-staticcall-value0-failed$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-delegatecall-value0-success`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients reth_release --corpus precompiles --case "^nested-delegatecall-value0-success$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-delegatecall-value0-failed`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients reth_release --corpus precompiles --case "^nested-delegatecall-value0-failed$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-delegatecall-value1-success`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients reth_release --corpus precompiles --case "^nested-delegatecall-value1-success$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-delegatecall-value1-failed`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients reth_release --corpus precompiles --case "^nested-delegatecall-value1-failed$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-callcode-value0-success`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients reth_release --corpus precompiles --case "^nested-callcode-value0-success$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-callcode-value0-failed`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients reth_release --corpus precompiles --case "^nested-callcode-value0-failed$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-callcode-value1-success`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients reth_release --corpus precompiles --case "^nested-callcode-value1-success$" --output runs/reproduce`
- **matches** · `precompiles-final` / `nested-callcode-value1-failed`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients reth_release --corpus precompiles --case "^nested-callcode-value1-failed$" --output runs/reproduce`
- **matches** · `precompiles-final` / `root-success`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients reth_release --corpus precompiles --case "^root-success$" --output runs/reproduce`
- **matches** · `precompiles-final` / `root-failed`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/precompiles-final/manifest.json --clients reth_release --corpus precompiles --case "^root-failed$" --output runs/reproduce`
- **matches** · `verified-a` / `call-return42`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^call-return42$" --output runs/reproduce`
- **matches** · `verified-a` / `call-siblings-ok-revert`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^call-siblings-ok-revert$" --output runs/reproduce`
- **matches** · `verified-a` / `call-siblings-revert-ok`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^call-siblings-revert-ok$" --output runs/reproduce`
- **matches** · `verified-a` / `call-mixed-create`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^call-mixed-create$" --output runs/reproduce`
- **matches** · `verified-a` / `call-gas7400`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^call-gas7400$" --output runs/reproduce`
- **matches** · `verified-a` / `call-mcopy`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^call-mcopy$" --output runs/reproduce`
- **matches** · `verified-a` / `call-destroy`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^call-destroy$" --output runs/reproduce`
- **matches** · `verified-a` / `state-only-nonempty-output`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^state-only-nonempty-output$" --output runs/reproduce`
...
- **matches** · `verified-a` / `vm-only-nonempty-output`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^vm-only-nonempty-output$" --output runs/reproduce`
...
- **matches** · `verified-a` / `prefunded-empty`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^prefunded-empty$" --output runs/reproduce`
- **matches** · `verified-a` / `empty-types`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^empty-types$" --output runs/reproduce`
...
- **matches** · `verified-a` / `control-storage-after-many`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^control-storage-after-many$" --output runs/reproduce`
...
- **matches** · `verified-a` / `call-unknown-field`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^call-unknown-field$" --output runs/reproduce`
...
- **matches** · `verified-a` / `raw-valid`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^raw-valid$" --output runs/reproduce`
- **matches** · `verified-a` / `auth-set`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^auth-set$" --output runs/reproduce`
- **matches** · `verified-a` / `auth-replace`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^auth-replace$" --output runs/reproduce`
- **matches** · `verified-a` / `auth-clear`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^auth-clear$" --output runs/reproduce`
- **matches** · `verified-a` / `auth-set-revert`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^auth-set-revert$" --output runs/reproduce`
- **matches** · `verified-fork-followup` / `destroy-trace-55`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-fork-followup/manifest.json --clients reth_release --corpus fork-followup --case "^destroy-trace-55$" --output runs/reproduce`
- **matches** · `verified-fork-followup` / `destroy-trace-56`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-fork-followup/manifest.json --clients reth_release --corpus fork-followup --case "^destroy-trace-56$" --output runs/reproduce`
- **matches** · `verified-fork-followup` / `beacon-call-55`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-fork-followup/manifest.json --clients reth_release --corpus fork-followup --case "^beacon-call-55$" --output runs/reproduce`
...
- **matches** · `verified-fork-followup` / `beacon-call-56`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-fork-followup/manifest.json --clients reth_release --corpus fork-followup --case "^beacon-call-56$" --output runs/reproduce`
...
- **matches** · `verified-forks` / `destroy-trace-55`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^destroy-trace-55$" --output runs/reproduce`
- **matches** · `verified-forks` / `mcopy-trace-55`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^mcopy-trace-55$" --output runs/reproduce`
- **matches** · `verified-forks` / `destroy-trace-56`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^destroy-trace-56$" --output runs/reproduce`
- **matches** · `verified-forks` / `mcopy-trace-56`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^mcopy-trace-56$" --output runs/reproduce`
- **matches** · `verified-initial` / `replay-tree-trace`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^replay-tree-trace$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `replay-tree-stateDiff`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^replay-tree-stateDiff$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `replay-tree-vmTrace`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^replay-tree-vmTrace$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `replay-revert-trace`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^replay-revert-trace$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `replay-revert-stateDiff`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^replay-revert-stateDiff$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `replay-revert-vmTrace`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^replay-revert-vmTrace$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `replay-7702-trace`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^replay-7702-trace$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `replay-7702-stateDiff`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^replay-7702-stateDiff$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `replay-7702-vmTrace`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^replay-7702-vmTrace$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-tree-trace`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^call-tree-trace$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-tree-stateDiff`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^call-tree-stateDiff$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-tree-vmTrace`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^call-tree-vmTrace$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-empty-types`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^call-empty-types$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-constructor`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^call-constructor$" --output runs/reproduce`
- **matches** · `verified-initial` / `raw-valid`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^raw-valid$" --output runs/reproduce`
- **matches** · `verified-initial` / `call-tree-trace-priced`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^call-tree-trace-priced$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-tree-stateDiff-priced`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^call-tree-stateDiff-priced$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-tree-vmTrace-priced`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^call-tree-vmTrace-priced$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-empty-types-priced`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^call-empty-types-priced$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-constructor-priced`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^call-constructor-priced$" --output runs/reproduce`
- **matches** · `verified-initial` / `raw-valid-current-nonce`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^raw-valid-current-nonce$" --output runs/reproduce`
- **matches** · `verified-initial` / `call-transfer-trace`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^call-transfer-trace$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-transfer-stateDiff`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^call-transfer-stateDiff$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-transfer-vmTrace`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^call-transfer-vmTrace$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `call-identity`: Unrequested stateDiff is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^call-identity$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `replay-transfer-trace`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^replay-transfer-trace$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `replay-transfer-stateDiff`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^replay-transfer-stateDiff$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `replay-transfer-vmTrace`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^replay-transfer-vmTrace$" --output runs/reproduce`
...
- **matches** · `verified-pruned-ready` / `latest-call`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-pruned-ready/manifest.json --clients reth_release --corpus pruned --case "^latest-call$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `call-return42`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^call-return42$" --output runs/reproduce`
- **matches** · `verified-repeat` / `call-siblings-revert-ok`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^call-siblings-revert-ok$" --output runs/reproduce`
- **matches** · `verified-repeat` / `call-mixed-create`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^call-mixed-create$" --output runs/reproduce`
- **matches** · `verified-repeat` / `call-gas7400`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^call-gas7400$" --output runs/reproduce`
- **matches** · `verified-repeat` / `call-mcopy`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^call-mcopy$" --output runs/reproduce`
- **matches** · `verified-repeat` / `state-only-nonempty-output`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^state-only-nonempty-output$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-valid`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-valid$" --output runs/reproduce`
- **matches** · `verified-repeat` / `auth-clear`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^auth-clear$" --output runs/reproduce`
- **matches** · `verified-repeat` / `auth-set-revert`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^auth-set-revert$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-valid-trace`: Unrequested vmTrace is null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-valid-trace$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-valid-stateDiff`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-valid-stateDiff$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-valid-vmTrace`: Unrequested trace is an empty array.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-valid-vmTrace$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `constructor`: Output remains a byte string under every trace selection.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^constructor$" --output runs/reproduce`
...
- **matches** · `verified-a` / `transaction-tree`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^transaction-tree$" --output runs/reproduce`
...
- **matches** · `verified-a` / `block-2`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^block-2$" --output runs/reproduce`
...
- **matches** · `verified-forks` / `block-36`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^block-36$" --output runs/reproduce`
- **matches** · `verified-forks` / `block-48`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^block-48$" --output runs/reproduce`
- **matches** · `verified-forks` / `block-51`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^block-51$" --output runs/reproduce`
- **matches** · `verified-forks` / `block-60`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^block-60$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `transaction-tree`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^transaction-tree$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `transaction-revert`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^transaction-revert$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `block-tree`: Failed frames have an explicit result; REVERT preserves return bytes and measured gas.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^block-tree$" --output runs/reproduce`
...
- **change_needed** · `verified-a` / `get-nested-positive`: Return the transaction-tree record at [6, 0], or null if absent. Compared with the same client and transaction; precompile inclusion can shift sibling indexes.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^get-nested-positive$" --output runs/reproduce`
- **change_needed** · `verified-a` / `get-nested-parent`: Return the transaction-tree record at [6], or null if absent. Compared with the same client and transaction; precompile inclusion can shift sibling indexes.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^get-nested-parent$" --output runs/reproduce`
- **change_needed** · `verified-initial` / `get-root`: Return the transaction-tree record at [], or null if absent. Compared with the same client and transaction; precompile inclusion can shift sibling indexes.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^get-root$" --output runs/reproduce`
- **change_needed** · `verified-initial` / `get-zero`: Return the transaction-tree record at [0], or null if absent. Compared with the same client and transaction; precompile inclusion can shift sibling indexes.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^get-zero$" --output runs/reproduce`
- **change_needed** · `verified-initial` / `get-one`: Return the transaction-tree record at [1], or null if absent. Compared with the same client and transaction; precompile inclusion can shift sibling indexes.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^get-one$" --output runs/reproduce`
- **matches** · `verified-initial` / `get-nested`: Return the transaction-tree record at [0, 0], or null if absent. Compared with the same client and transaction; precompile inclusion can shift sibling indexes.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^get-nested$" --output runs/reproduce`
- **change_needed** · `verified-initial` / `get-transfer-root`: Return one object whose traceAddress equals []. Observed NoneType.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^get-transfer-root$" --output runs/reproduce`
...
- **matches** · `verified-a` / `get-path-wrong-type`: Malformed input returns invalid params (-32602).
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^get-path-wrong-type$" --output runs/reproduce`
- **matches** · `verified-a` / `call-wrong-type`: Malformed input returns invalid params (-32602).
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^call-wrong-type$" --output runs/reproduce`
- **matches** · `verified-a` / `call-unknown-mode`: Malformed input returns invalid params (-32602).
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^call-unknown-mode$" --output runs/reproduce`
- **matches** · `verified-a` / `call-scalar-mode`: Malformed input returns invalid params (-32602).
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^call-scalar-mode$" --output runs/reproduce`
- **matches** · `verified-initial` / `raw-invalid`: Malformed input returns invalid params (-32602).
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^raw-invalid$" --output runs/reproduce`
...
- **matches** · `verified-a` / `filter-all`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 13 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^filter-all$" --output runs/reproduce`
- **matches** · `verified-initial` / `filter-all`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 13 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^filter-all$" --output runs/reproduce`
- **matches** · `verified-initial` / `filter-from`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 5 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^filter-from$" --output runs/reproduce`
- **matches** · `verified-initial` / `filter-to`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 2 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^filter-to$" --output runs/reproduce`
- **change_needed** · `verified-initial` / `filter-both`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 1 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^filter-both$" --output runs/reproduce`
...
- **matches** · `verified-a` / `filter-from-empty-to-set`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 2 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^filter-from-empty-to-set$" --output runs/reproduce`
- **matches** · `verified-a` / `filter-to-empty-from-set`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 5 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^filter-to-empty-from-set$" --output runs/reproduce`
- **matches** · `verified-initial` / `filter-empty`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 13 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^filter-empty$" --output runs/reproduce`
...
- **matches** · `verified-a` / `filter-created-to`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 1 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^filter-created-to$" --output runs/reproduce`
- **matches** · `verified-a` / `filter-creator-from`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 7 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^filter-creator-from$" --output runs/reproduce`
- **matches** · `verified-a` / `filter-suicide-from`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 1 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^filter-suicide-from$" --output runs/reproduce`
- **matches** · `verified-a` / `filter-suicide-beneficiary`: Address matching is OR within each list, AND across lists, with action-specific endpoints. Expected 2 records from this client's block trace.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^filter-suicide-beneficiary$" --output runs/reproduce`
...
- **matches** · `verified-a` / `many-storage-write-revert-read`: Sequential calls retain prior writes and roll back reverted writes.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^many-storage-write-revert-read$" --output runs/reproduce`
- **matches** · `verified-repeat` / `many-storage-write-revert-read`: Sequential calls retain prior writes and roll back reverted writes.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^many-storage-write-revert-read$" --output runs/reproduce`
...
- **matches** · `verified-a` / `raw-nonce-high`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^raw-nonce-high$" --output runs/reproduce`
- **matches** · `verified-a` / `raw-wrong-chain`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^raw-wrong-chain$" --output runs/reproduce`
- **matches** · `verified-a` / `raw-insufficient-funds`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^raw-insufficient-funds$" --output runs/reproduce`
- **matches** · `verified-a` / `raw-low-gas`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^raw-low-gas$" --output runs/reproduce`
- **matches** · `verified-a` / `raw-below-basefee`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^raw-below-basefee$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `raw-valid-default-block`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^raw-valid-default-block$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-nonce-high`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-nonce-high$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-wrong-chain`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-wrong-chain$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-insufficient-funds`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-insufficient-funds$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-low-gas`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-low-gas$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-below-basefee`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-below-basefee$" --output runs/reproduce`
...
- **matches** · `verified-repeat` / `raw-nonce-high-trace`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-nonce-high-trace$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-nonce-high-stateDiff`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-nonce-high-stateDiff$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-nonce-high-vmTrace`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-nonce-high-vmTrace$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-wrong-chain-trace`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-wrong-chain-trace$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-wrong-chain-stateDiff`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-wrong-chain-stateDiff$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-wrong-chain-vmTrace`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-wrong-chain-vmTrace$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-insufficient-funds-trace`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-insufficient-funds-trace$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-insufficient-funds-stateDiff`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-insufficient-funds-stateDiff$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-insufficient-funds-vmTrace`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-insufficient-funds-vmTrace$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-low-gas-trace`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-low-gas-trace$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-low-gas-stateDiff`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-low-gas-stateDiff$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-low-gas-vmTrace`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-low-gas-vmTrace$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-below-basefee-trace`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-below-basefee-trace$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-below-basefee-stateDiff`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-below-basefee-stateDiff$" --output runs/reproduce`
- **matches** · `verified-repeat` / `raw-below-basefee-vmTrace`: Return one complete JSON-RPC response, including on validation failure.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-repeat/manifest.json --clients reth_release --corpus repeat --case "^raw-below-basefee-vmTrace$" --output runs/reproduce`
...
- **matches** · `verified-a` / `block-3`: A PoS block has no synthetic PoW reward records.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^block-3$" --output runs/reproduce`
...
- **matches** · `verified-forks` / `block-52`: A PoS block has no synthetic PoW reward records.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^block-52$" --output runs/reproduce`
- **matches** · `verified-forks` / `block-55`: A PoS block has no synthetic PoW reward records.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^block-55$" --output runs/reproduce`
- **matches** · `verified-forks` / `block-56`: A PoS block has no synthetic PoW reward records.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^block-56$" --output runs/reproduce`
- **matches** · `verified-forks` / `block-59`: A PoS block has no synthetic PoW reward records.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^block-59$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `block-transfer`: A PoS block has no synthetic PoW reward records.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^block-transfer$" --output runs/reproduce`
...
- **matches** · `verified-a` / `filter-two-blocks`: Range traces equal concatenated per-block traces in canonical order.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-a/manifest.json --clients reth_release --corpus a --case "^filter-two-blocks$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-35`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^filter-35$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-36`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^filter-36$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-47`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^filter-47$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-48`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^filter-48$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-51`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^filter-51$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-52`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^filter-52$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-55`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^filter-55$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-56`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^filter-56$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-59`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^filter-59$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-60`: A single-block filter agrees with trace_block at the same fork.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^filter-60$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-across-36`: A fork-crossing range equals the corresponding per-block traces.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^filter-across-36$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-across-48`: A fork-crossing range equals the corresponding per-block traces.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^filter-across-48$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-across-52`: A fork-crossing range equals the corresponding per-block traces.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^filter-across-52$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-across-56`: A fork-crossing range equals the corresponding per-block traces.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^filter-across-56$" --output runs/reproduce`
- **matches** · `verified-forks` / `filter-across-60`: A fork-crossing range equals the corresponding per-block traces.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^filter-across-60$" --output runs/reproduce`
...
- **matches** · `verified-fork-followup` / `system-beacon-55-560`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-fork-followup/manifest.json --clients reth_release --corpus fork-followup --case "^system-beacon-55-560$" --output runs/reproduce`
- **matches** · `verified-fork-followup` / `system-beacon-55-8751`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-fork-followup/manifest.json --clients reth_release --corpus fork-followup --case "^system-beacon-55-8751$" --output runs/reproduce`
- **matches** · `verified-fork-followup` / `system-beacon-56-560`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-fork-followup/manifest.json --clients reth_release --corpus fork-followup --case "^system-beacon-56-560$" --output runs/reproduce`
- **matches** · `verified-fork-followup` / `system-beacon-56-8751`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-fork-followup/manifest.json --clients reth_release --corpus fork-followup --case "^system-beacon-56-8751$" --output runs/reproduce`
...
- **matches** · `verified-forks` / `system-beacon-55-560`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^system-beacon-55-560$" --output runs/reproduce`
- **matches** · `verified-forks` / `system-beacon-55-8751`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^system-beacon-55-8751$" --output runs/reproduce`
- **matches** · `verified-forks` / `system-beacon-56-560`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^system-beacon-56-560$" --output runs/reproduce`
- **matches** · `verified-forks` / `system-beacon-56-8751`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^system-beacon-56-8751$" --output runs/reproduce`
- **matches** · `verified-forks` / `system-beacon-57-560`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^system-beacon-57-560$" --output runs/reproduce`
- **matches** · `verified-forks` / `system-beacon-57-8751`: Historical beacon-root storage excludes the following block system update.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-forks/manifest.json --clients reth_release --corpus forks --case "^system-beacon-57-8751$" --output runs/reproduce`
...
- **matches** · `verified-initial` / `get-missing`: A missing transaction or tree path returns null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^get-missing$" --output runs/reproduce`
- **matches** · `verified-initial` / `transaction-missing`: Unknown transaction returns null, not an empty collection or RPC error.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^transaction-missing$" --output runs/reproduce`
- **change_needed** · `verified-initial` / `replay-missing`: Unknown transaction returns null, not an empty collection or RPC error.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^replay-missing$" --output runs/reproduce`
- **matches** · `verified-initial` / `get-missing-tx`: A missing transaction or tree path returns null.
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-initial/manifest.json --clients reth_release --corpus initial --case "^get-missing-tx$" --output runs/reproduce`
...
- **change_needed** · `verified-pruned-ready` / `old-transaction`: Unavailable historical state uses the proposed pruned-history error (4444).
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-pruned-ready/manifest.json --clients reth_release --corpus pruned --case "^old-transaction$" --output runs/reproduce`
- **change_needed** · `verified-pruned-ready` / `old-replay`: Unavailable historical state uses the proposed pruned-history error (4444).
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-pruned-ready/manifest.json --clients reth_release --corpus pruned --case "^old-replay$" --output runs/reproduce`
- **change_needed** · `verified-pruned-ready` / `old-block`: Unavailable historical state uses the proposed pruned-history error (4444).
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-pruned-ready/manifest.json --clients reth_release --corpus pruned --case "^old-block$" --output runs/reproduce`
- **change_needed** · `verified-pruned-ready` / `old-filter`: Unavailable historical state uses the proposed pruned-history error (4444).
  ...
  Reproduce: `uv run trace-interop run --lock evidence/2026-09-21/verified-pruned-ready/manifest.json --clients reth_release --corpus pruned --case "^old-filter$" --output runs/reproduce`
