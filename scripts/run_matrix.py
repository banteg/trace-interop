...
p.add_argument('--corpora',default='initial,a,repeat,forks,fork-followup,precompiles,precompile-values,raw-validation,coverage,fee-policy,fee-compat,callmany-isolation,h30,mined-probes,reorg-safe,pruned')
args=p.parse_args()
