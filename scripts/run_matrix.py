...
p.add_argument('--reproduce-lock',help='explicitly reproduce a historical combined lock instead of refreshing')
p.add_argument('--output',required=True)
p.add_argument('--corpora',default='initial,a,repeat,forks,fork-followup,precompiles,precompile-values,raw-validation,coverage,fee-policy,fee-compat,callmany-isolation,h30,probes-prague,probes-forks,mined-probes,reorg-safe,pruned')
args=p.parse_args()
